...
const double Forward::alpha =0.25;
const double Forward::beta =1.0;
const double Forward::gamma =1.0;

Forward::Forward(unsigned& id,double (&attr)[_Attributes]):Player(id,attr)
{
...
void Forward::print(ostream&)const
{
	cout << "F " ; Player::print(cout);
}

void Forward::update(double (&target_point)[_Coordinates], double (&global)[_Coordinates], Rink& _rink)
{
